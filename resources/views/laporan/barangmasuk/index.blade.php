          ...
          <div class="row">
            <div class="col-lg-6 col-6">
              <div class="small-box btn btn-success">
                <div class="inner">
                  <a href="/BarangMasuk/cetak" class="btn" target="blank">
            ...
            <div class="col-lg-6 col-6">
              <div class="small-box btn btn-warning">
                <div class="inner">
                  ...
                  <button type="button" class="btn" data-toggle="modal" data-target="#laporanMasuk">
                    <i class="fas fa-calendar"> Laporan (Filter)</i>
                  </button>
                  <!-- Modal -->
                  <div class="modal fade" id="laporanMasuk" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form action="/laporanMasukPertanggal/cetak" method="get" target="blank">
